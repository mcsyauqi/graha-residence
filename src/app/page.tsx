          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "24px" }}>
            {[
              ...
              <div key={i} style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  <div style={{ fontSize: "24px", fontWeight: "700", color: "white", fontFamily: "Montserrat" }}>{stat.value}</div>
              ...
              <div className="card" style={{ height: "100%" }}>
                <div style={{ position: "relative", height: "200px" }}>
                  ...
                  <div style={{ position: "absolute", bottom: "12px", left: "12px" }}>
                    <span style={{ color: "white", fontWeight: "700", fontSize: "18px", fontFamily: "Montserrat" }}>{project.priceDisplay}</span>
                  </div>
                </div>

                <div style={{ padding: "20px" }}>
                  <h3 style={{ fontSize: "18px", fontWeight: "700", marginBottom: "8px", color: "#1E3A5F", fontFamily: "Montserrat" }}>{project.name}</h3>
        ...
        <div className="grid-4">
          {features.map((f, i) => (
            <div key={i} className="card" style={{ padding: "32px", textAlign: "center" }}>
              ...
              <h3 style={{ fontSize: "18px", fontWeight: "700", marginBottom: "12px", color: "#1E3A5F", fontFamily: "Montserrat" }}>{f.title}</h3>
          ...
          {facilities.map((f, i) => (
            <div key={i} style={{ position: "relative", height: "240px", borderRadius: "16px", overflow: "hidden" }}>
              ...
              <div style={{ position: "absolute", bottom: "20px", left: "20px", right: "20px" }}>
                <h3 style={{ color: "white", fontSize: "20px", fontWeight: "700", marginBottom: "8px", fontFamily: "Montserrat" }}>{f.name}</h3>
        ...
        >
          <div style={{ display: "grid", gridTemplateColumns: "1fr" }} className="kpr-grid">
            ...
            <div style={{ padding: "32px", backgroundColor: "#1E3A5F", color: "white" }}>
              <h3 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "24px", fontFamily: "Montserrat", color: "white" }}>Estimasi Cicilan</h3>

              <div style={{ marginBottom: "24px" }}>
                <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.7)", marginBottom: "8px" }}>Cicilan Per Bulan</p>
                <p style={{ fontSize: "36px", fontWeight: "800", color: "#C9A962", fontFamily: "Montserrat" }}>{formatCurrency(result.cicilanPerBulan)}</p>
              </div>
  ...
  return (
    ...
    >
      <div className="container" style={{ textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: "clamp(28px, 5vw, 42px)", fontWeight: "800", color: "#1E3A5F", marginBottom: "32px", fontFamily: "Montserrat" }}>
...
function CTASection() {
  return (
    <section style={{ padding: "80px 0", background: "linear-gradient(135deg, #1E3A5F 0%, #2D5A8F 100%)" }}>
      <div className="container" style={{ textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(28px, 5vw, 42px)", fontWeight: "800", color: "white", marginBottom: "16px", fontFamily: "Montserrat" }}>
