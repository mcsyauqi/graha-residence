      ...
      <section className="section bg-white">
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "40px" }} className="detail-grid">
            {/* Main */}
            <div>
              <h1 style={{ fontSize: "32px", fontWeight: "800", color: "#1E3A5F", marginBottom: "16px", fontFamily: "'Cormorant Garamond', serif" }}>{project.name}</h1>
              ...
              <div style={{ backgroundColor: "#f8fafc", padding: "24px", borderRadius: "16px", marginBottom: "32px" }}>
                <h3 style={{ fontSize: "18px", fontWeight: "700", color: "#1E3A5F", marginBottom: "20px", fontFamily: "'Cormorant Garamond', serif" }}>Keunggulan Lokasi</h3>
              ...
              <div style={{ marginBottom: "32px" }}>
                <h3 style={{ fontSize: "18px", fontWeight: "700", color: "#1E3A5F", marginBottom: "16px", fontFamily: "'Cormorant Garamond', serif" }}>Fasilitas Cluster</h3>
              ...
              {/* Unit Types */}
              <div>
                <h3 style={{ fontSize: "18px", fontWeight: "700", color: "#1E3A5F", marginBottom: "20px", fontFamily: "'Cormorant Garamond', serif" }}>Pilihan Tipe Unit</h3>
                  ...
                  {project.unitTypes.map((unit, i) => (
                    <div key={i} className="card" style={{ padding: "20px", display: "flex", flexDirection: "column", gap: "16px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "12px" }}>
                        <h4 style={{ fontSize: "18px", fontWeight: "700", color: "#1E3A5F", fontFamily: "'Cormorant Garamond', serif" }}>{unit.name}</h4>
                        <span style={{ fontSize: "20px", fontWeight: "700", color: "#C9A962", fontFamily: "'Cormorant Garamond', serif" }}>{formatCurrency(unit.price)}</span>
                      </div>
            ...
            <div>
              <div className="card" style={{ padding: "24px", position: "sticky", top: "100px" }}>
                ...
                <p style={{ fontSize: "28px", fontWeight: "800", color: "#1E3A5F", marginBottom: "24px", fontFamily: "'Cormorant Garamond', serif" }}>{project.priceDisplay}</p>
