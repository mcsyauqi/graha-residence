        ...
        >
          ...
          <div>
            <Link href="/" style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
              ...
              >
                <span style={{ color: "#1E3A5F", fontWeight: "bold", fontSize: "24px", fontFamily: "Montserrat" }}>G</span>
              </div>
              <div>
                <div style={{ fontFamily: "Montserrat", fontWeight: "700", fontSize: "20px" }}>Graha Residence</div>
          ...
          {/* Proyek */}
          <div>
            <h4 style={{ fontSize: "16px", fontWeight: "600", marginBottom: "20px", fontFamily: "Montserrat" }}>Proyek</h4>
          ...
          {/* Layanan */}
          <div>
            <h4 style={{ fontSize: "16px", fontWeight: "600", marginBottom: "20px", fontFamily: "Montserrat" }}>Layanan</h4>
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          {/* Kontak */}
          <div>
            <h4 style={{ fontSize: "16px", fontWeight: "600", marginBottom: "20px", fontFamily: "Montserrat" }}>Kontak</h4>
